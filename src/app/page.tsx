  ...
  return (
    <div className="min-h-screen bg-base-100">
      ...
      <div className="hero min-h-screen bg-gradient-to-br from-primary/20 to-secondary/20">
        <div className="hero-content text-center">
          <div className="max-w-md">
            <h1 className="text-5xl font-bold text-primary">Nash Festival Memories</h1>
            <p className="py-6 text-base-content">
              Capture and share your unforgettable moments from Nashville&apos;s most vibrant music festivals. 
              Connect with fellow music lovers and relive the magic.
            </p>
      ...
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-base-content">Features</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="card bg-base-200 shadow-xl">
            <div className="card-body">
              ...
              <p>Upload and share your favorite festival moments with the community</p>
          ...
          <div className="card bg-base-200 shadow-xl">
            <div className="card-body">
              ...
              <p>Discover new artists and keep track of your favorite performances</p>
              <div className="card-actions justify-end">
      ...
      <div className="hero py-16 bg-base-200">
        <div className="hero-content text-center">
          <div className="max-w-md">
            <h2 className="text-3xl font-bold mb-4">Ready to Share Your Memories?</h2>
            <p className="mb-6">Join our community and start sharing your festival experiences today!</p>
